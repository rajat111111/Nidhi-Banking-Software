...
import { useSubmitFdAccountDocsMutation } from "../../../../features/api/fdAccounts";
...
const FdDocuments = () => {
  ...
  const [submitFdAccountDocs, { isError, isLoading, isSuccess, error, data }] =
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      await submitFdAccountDocs({ id: id, values: formData });
    } catch (err) {
      console.log(err);
    }
  };
